...
@section('content')
        ...
        <div class="lg:w-1/2 flex justify-center">
            <div class="w-full max-w-[530px] aspect-video">
                {{-- <iframe class="w-full h-full rounded-lg shadow-md"
                    ...
                    <img src="{{ asset('assets/infra2.png') }}" alt="" class="w-full h-full md:min-w-[350px] md:min-h-[350px]"/>
    ...
    <section class="mx-auto px-5 lg:px-20 py-20 bg-[#F4F4F4]">
        <h2 class="text-2xl font-semibold text-center pb-12">{{ __('Benefits_CNG') }}</h2>
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mt-12">
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <p class="mt-4 text-sm lg:text-lg font-medium text-gray-700">{{ __('Benefits_ecofuel') }}</p>
            </div>
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <p class="mt-4 text-sm lg:text-lg font-medium text-gray-700">{{ __('Benefits_gasemisi') }}</p>
            </div>
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <p class="mt-4 text-sm lg:text-lg font-medium text-gray-700">{{ __('Benefits_invest') }}</p>
            </div>
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <p class="mt-4 text-sm lg:text-lg font-medium text-gray-700">{{ __('Benefits_machine') }}</p>
            </div>
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <p class="mt-4 text-sm lg:text-lg font-medium text-gray-700">{{ __('Benefits_safety') }}</p>
            </div>
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <p class="mt-4 text-sm lg:text-lg font-medium text-gray-700">{{ __('Benefits_cost') }}</p>
            </div>
        </div>
    </section>
    ...
    <section class="mx-auto px-6 lg:px-20 pt-20">
        <h2 class="text-3xl pb-5">{{ __('MS_tittle') }}</h2>
        <p class="text-md mb-8">
            {{ __('MS_desc') }}
        </p>

        <div class="max-w-[1200px] mx-auto overflow-hidden rounded-lg shadow-lg">
            <img src="{{ asset('assets/MS.png') }}" alt="Mother Station" class="w-full h-full object-cover">
        </div>
    </section>
    ...
    <section class="bg-white py-16">
        <div class="container mx-auto">
            <h2 class="text-3xl font-medium text-center mb-10">{{ __('Clients_tittle') }}</h2>
            <div class="p-2">
